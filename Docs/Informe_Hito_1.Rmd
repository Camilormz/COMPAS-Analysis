...
El dataset compas analizado en el siguiente informe, esta dividido bloques distintos que son tiene al dataframe "people" como nodo central del cual se despreden 6 ramas correspondientes a los siguientes dataframe: "compas", "jailhistory", "casearrest", "people", "summary", "prisonhistory" y "charge". Cada bloque esta compuesto por una serie de atributos.
